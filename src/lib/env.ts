const env = {
  ...
  DASHBOARD_DATABASE_URL: process.env.DASHBOARD_DATABASE_URL,
  DASHBOARD_DATA_SOURCE: process.env.DASHBOARD_DATA_SOURCE ?? (process.env.DASHBOARD_DATABASE_URL ? "pos" : "legacy"),
